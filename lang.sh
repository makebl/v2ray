...
shadowsocks_password_config() {
	...
	while :; do
		...
		read -p "$(echo -e "(默认密码: ${cyan}langblog.com$none)"): " sspass
		[ -z "$sspass" ] && sspass="langblog.com"
		case $sspass in
		*[/$]*)
			echo
...
install_v2ray() {
	...
	if [[ $local_install ]]; then
		...
		pushd /tmp
		git clone https://github.com/langboy/v2ray -b "$_gitbranch" /etc/v2ray/langboy/v2ray --depth=1
		popd
...
while :; do
	echo
	echo "........... V2Ray 一键安装脚本 & 管理脚本 by lang .........."
	echo
	echo "帮助说明: https://langv2.com/post/1/"
	echo
	echo "搭建教程: https://langv2.com/post/2/"
	echo
	echo " 1. 安装"
	echo
	echo " 2. 卸载"
